...
Once you have installed and configured `php-cs-fixer`, you can proceed to install the SublimeLinter-php-cs-fixer plugin if it is not yet installed.
...
1. When the plugin list appears, type `php-cs-fixer`. Among the entries you should see `SublimeLinter-php-cs-fixer`. If that entry is not highlighted, use the keyboard or mouse to select it.
